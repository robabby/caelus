...
**Status: implemented.** The suite holds 3,218 conformance checks; the new
...
star-anchored modes (`galcent_0sag`, `true_citra`) shipped with the
fixed-star catalog in Tier 2.
