...
Expect these to still move before 1.0: the derived-charts surface (new in
0.7.0), the MCP tool schemas, and any low-level helper not re-exported from the
package root. Treat unexported internals as unstable.
