...
There are two ways to connect, with the same twenty-nine tools either way:
...
After the client reloads, it should list **twenty-nine** tools. Ask it to enumerate
...
`realm`, and `constraints` for archetypal charts — see the
[Interpretation](/docs/interpretation) and
[Provenance](/docs/provenance) guides), and `counterfactual_chart` (a birth
...
If you see all twenty-nine, the server is wired correctly. The server also exposes two
