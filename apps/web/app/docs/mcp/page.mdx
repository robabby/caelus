...
There are two ways to connect, with the same thirty-one tools either way:
...
After the client reloads, it should list **thirty-one** tools. Ask it to enumerate
...
If you see all thirty-one, the server is wired correctly. The server also exposes two
