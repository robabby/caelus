...
There are two ways to connect, with the same twenty-four tools either way:
...
After the client reloads, it should list **twenty-four** tools. Ask it to enumerate
...
If you see all twenty-four, the server is wired correctly. The server also exposes two
