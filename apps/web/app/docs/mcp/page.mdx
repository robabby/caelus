...
There are two ways to connect, with the same twenty-three tools either way:
...
After the client reloads, it should list **twenty-three** tools. Ask it to enumerate
...
Yogini, or Ashtottari periods), `vargas` (Parashari divisional charts), and
...
If you see all twenty-three, the server is wired correctly. The server also exposes two
