...
There are two ways to connect, with the same twenty-two tools either way:
...
After the client reloads, it should list **twenty-two** tools. Ask it to enumerate
...
If you see all twenty-two, the server is wired correctly. The server also exposes two
