...
const PACKAGES: Array<[keyof typeof NPM, string, string]> = [
  ...
  ["mcp", "caelus-mcp", "Twenty-three chart tools for AI agents: natal charts, transits, synastry, event search, electional, lots, time-lords, directions, and the Vedic layer (nakshatras, dashas, vargas, yogas)."],
  ...
  return (
    <main className="container page">
      ...
      <ul style={{ listStyle: "none", padding: 0, margin: "1.5rem 0", display: "grid", gap: "0.6rem", lineHeight: 1.5 }}>
        ...
        <li>🤖 <A href="/docs/mcp"><code>caelus-mcp</code></A> gives Claude, Cursor, and other MCP clients twenty-three chart tools</li>
