...
const PACKAGES: Array<[keyof typeof NPM, string, string]> = [
  ...
  ["mcp", "caelus-mcp", "Twenty-two chart tools for AI agents: natal charts, transits, synastry, event search, electional, lots, time-lords, directions, and the Vedic layer (nakshatras, dashas, vargas, yogas)."],
